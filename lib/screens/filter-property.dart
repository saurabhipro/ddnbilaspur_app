...
import 'package:ddnbilaspur_mob/screens/survey_image_capture.dart';
            ...
            onTap: () {
              if (!property.surveyed! &&
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            ImageCapture(property: property)));
              } else {
                Navigator.push(
                    context,
                    MaterialPageRoute(
